        ...
        base.init = function(){
            ...
            main_fab_btn.click(function(e){
            	...
            	if ($(".kc_fab_overlay").length > 0){
                    ...
                    '<div><button style="height: 100vh; width: 100%;  display: flex; justify-content: center; align-items: center;" class="form-control d-flex justify-content-center btn btn-primary text-center" type="button" disabled>'
                    +'</button></div>'
                    +'</div>');
