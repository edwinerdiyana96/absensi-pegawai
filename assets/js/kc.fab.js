            ...
            main_fab_btn.click(function(e){
            	...
            	if ($(".kc_fab_overlay").length > 0){
                   ...
                   $('body').append('<div class="kc_fab_overlay">'
                    ...
                    +'<span class="spinner-border spinner-border-lg" role="status" aria-hidden="true" style="margin-top:80%"></span>&ensp;&ensp;<h4 style="margin-top:80%">LOADING...</h4></button></div>'
                    +'</div>');
                    ...
                    $('body').append('<div class="kc_fab_overlay"><div class="container h-100"><div class="row justify-content-center align-self-center align-items-center h-100"><div class="jumbotron"><p class="text-center" style="margin-left: 10px">Jika anda melihat pesan ini terlalu lama, Maka yang anda harus lakukan yaitu :&ensp;<li> Aktifkan mode GPS di HP anda.</li>&ensp;<li> Cek kembali Koneksi HP Anda.</li>&ensp;<li> Refresh / Reload Kembali Halaman Ini.</li></p></div></div></div></div>');
