<div class="container-fluid dashboard-atas">
			...
			<div class="row">
				...
				<div class="col-xl-12 cold-md-12 col-lg-12">
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="form-group md-2 mb-3">
								<div>
									...
									<form action="<?= base_url('admin/rekap/filter') ?>" method="POST">
										...
										foreach ($data_absensi as $ds) : ?>
											<tr>
												...
												<td>
													...
													elseif ($ds['status'] == 0) : {
															if ($ds['time_in'] < '14:00:00' && $ds['date'] == date('Y-m-d')) {
												...
												<td>
													<a type="button" class="btn btn-primary" data-toggle="modal" data-target="#editDataAbsensi" href="" data-jam_masuk="<?= $ds['time_in'] ?>" data-jam_pulang="<?= $ds['time_out'] ?>" data-status="<?= $ds['status'] ?>" data-attendance_id="<?= $ds['attendance_id'] ?>" data-name="<?= $ds['name'] ?>" data-description="<?= $ds['description'] ?>">UPDATE</a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
						...
						<div class="modal fade" id="editDataAbsensi" tabindex="-1" role="dialog" aria-labelledby="editDataAbsensiLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="editDataAbsensiLabel">PERBARUI</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
									<div class="modal-body">
										<form action='<?= base_url('admin/updateuserabsensi'); ?>' method="POST">
											<div class="form-group">
												<label for="attendance_id" class="col-form-label" hidden>Attendance ID</label>
												...
												<input type="text" class="form-control jam_masuk" name="jam_masuk" id="jam_masuk">
												<label for="jam_pulang" class="col-form-label">Jam Pulang</label>
												<input type="text" class="form-control jam_pulang" name="jam_pulang" id="jam_pulang">
												<label for="status" class="col-form-label">Status Kehadiran</label>
	...
	$(document).ready(function() {
		$('#editDataAbsensi').on('show.bs.modal', function(event) {
			var button = $(event.relatedTarget) // Button that triggered the modal
			var jam_masuk = button.data('jam_masuk') //jam masuk
			var jam_pulang = button.data('jam_pulang') //jam pulang
