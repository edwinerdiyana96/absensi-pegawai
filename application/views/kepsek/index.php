                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-2">
                                Persentase Kehadiran Hari Ini</div>
                            <div class="h5 font-weight-bold text-gray-800"><?= number_format($hadir_hari_ini / $jumlah_pegawai * 100) ?>%</div>
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: <?= number_format($hadir_hari_ini / $jumlah_pegawai * 100) ?>%"></div>
                            </div>
                        </div>
                        <div class="col-auto">
                            <span style="color: Mediumslateblue;">
