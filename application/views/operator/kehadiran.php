...
<div class="container-fluid dashboard-atas">
	...
	<a href="<?= base_url('kirim_laporan/kirim_laporan_all/'); ?>" class="btn btn-info form-control">KIRIM FULL REKAP</a>
	<br>
	<br>
	<a href="<?= base_url('kirim_laporan/kirim_laporan_terlambat/'); ?>" class="btn btn-info form-control">KIRIM DATA TERLAMBAT</a>
	<br>
	<br>
	<a href="<?= base_url('whatsapp/send_tepat_waktu/'); ?>" class="btn btn-info form-control">KIRIM DATA TEPAT WAKTU</a>
	<!-- <br> -->
	<!-- <br> -->
